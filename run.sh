...
nasm -f bin lap_controller.asm -o lap_controller.bin
...
dd if=player2.bin of=disco.img bs=512 seek=4 conv=notrunc # Sector 5
dd if=lap_controller.bin of=disco.img bs=512 seek=5 conv=notrunc # Sector 6
